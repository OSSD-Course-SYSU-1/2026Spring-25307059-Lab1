...
export default class CommonConstants {
    ...
    /**
     * Pity threshold - guaranteed high prize after this many draws.
     */
    static readonly PITY_THRESHOLD: number = 50;
    /**
     * Soft pity start - increased probability after this many draws.
     */
    static readonly SOFT_PITY_START: number = 30;
    /**
     * High prize probability base (0-10000 scale).
     */
    static readonly HIGH_PRIZE_BASE_RATE: number = 60; // 0.6%
    /**
     * Medium prize probability base.
     */
    static readonly MEDIUM_PRIZE_BASE_RATE: number = 600; // 6%
    /**
     * Max history records.
     */
    static readonly MAX_HISTORY_RECORDS: number = 100;
}
/**
 * Enumerated Value.
 */
